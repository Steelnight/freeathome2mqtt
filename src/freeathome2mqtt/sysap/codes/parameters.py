"""GENERATED — A Free@Home channel/device parameter ID (e.g. a dimmer's minimum brightness).
...
Source: local-abbfreeathome's src/abbfreeathome/bin/parameter.py (MIT), itself converted from
Busch-Jaeger/node-free-at-home's src/parameterIds.ts (ISC).
"""
...
class Parameter(IntEnum):
    """A Free@Home channel/device parameter ID (e.g. a dimmer's minimum brightness)."""
