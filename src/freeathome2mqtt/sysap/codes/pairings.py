"""GENERATED — A Free@Home pairing ID: the meaning of a value on an input or output datapoint.
...
Source: local-abbfreeathome's src/abbfreeathome/bin/pairing.py (MIT), itself converted from
Busch-Jaeger/node-free-at-home's src/pairingIds.ts (ISC).
"""

from enum import IntEnum


class Pairing(IntEnum):
    """A Free@Home pairing ID: the meaning of a value on an input or output datapoint."""
