"""GENERATED — A Free@Home channel functionID: what kind of channel this is.
...
Source: local-abbfreeathome's src/abbfreeathome/bin/function.py (MIT), itself converted from
Busch-Jaeger/node-free-at-home's src/functionIds.ts (ISC).
"""
...
class Function(IntEnum):
    """A Free@Home channel functionID: what kind of channel this is."""
